...
@Getter
@Setter
public class EventTableViewItemMultiselectEventType {
	...
	//bunu silme
	public EventTableViewItemMultiselectEventType(Integer id, String spot, String title, String description, String country, String city,
			Double latitude, Double longitude, String color, String eventTypeImage, List<Integer> eventTypeId, Date eventDate,
			...
			String startDateStr, String endDateStr, Integer eventGroupId, Boolean isAlertEvent) {
	...
	public EventTableViewItemMultiselectEventType() {
