...
@Setter
@AllArgsConstructor
public class EventTableViewItemWrapper {

	private EventTableViewItem event;
	...
	public EventTableViewItemWrapper(EventTableViewItem event, List<SidebarEventMediaItem> mediaList,
