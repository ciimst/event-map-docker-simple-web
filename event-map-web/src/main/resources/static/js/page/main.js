var Main = {    
	...
	resizeDelta: 200,
	resizeTimeout: false,
	eventTableMode: false,
	eventTableViewMode:false,
    Init: function () {
...
//			Page.mapHelper.MyMap._onResize();	    
	...
	UserLocationStateSendToRedis: function(){
		
		var url = "/redis/userLastPage?locationUrl=" + window.location.href;
...
$(document).ready(function () {
	...
	Main.UserLocationStateSendToRedis();
