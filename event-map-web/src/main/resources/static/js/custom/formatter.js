var CustomFormatter = {    
    ...
    ConvertDMS: function (lat, lng, delimeter = "\n") {
        ...
        return latitude + " " + latitudeCardinal + delimeter + longitude + " " + longitudeCardinal;
    },
	...
	ConvertToLong: function(dateStr){
		return moment(dateStr,"DD.MM.YYYY HH:mm:ss").valueOf();
	}
}
